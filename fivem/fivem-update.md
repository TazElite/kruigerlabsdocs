---
title: "Updating the FiveM Client"
description: "A practical step-by-step Kruiger Labs guide to updating the fivem client."
category: "FiveM Servers"
order: 22
keywords: "Updating the FiveM Client step by step Kruiger Labs"
---

# Updating the FiveM Client

This guide walks through **Updating the FiveM Client** from preparation through verification, with a rollback path and the checks that matter in a real fivem servers environment.
