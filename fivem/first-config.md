---
title: "Adding a config.lua"
description: "A practical step-by-step Kruiger Labs guide to adding a config.lua."
category: "FiveM Servers"
order: 133
keywords: "Adding a config.lua step by step Kruiger Labs"
---

# Adding a config.lua

This guide walks through **Adding a config.lua** from preparation through verification, with a rollback path and the checks that matter in a real fivem servers environment.
